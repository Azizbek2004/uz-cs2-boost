    ...
    <div className="page-container">
      ...
      >
        ...
        <p style={{ color: "#555", fontSize: "13px", marginBottom: "32px" }}>
          In partnership with IT Park — empowering the next generation of
          esports athletes.
        </p>
      </motion.div>
      ...
      >
        {COURSES.map((course, i) => (
          <motion.div
            ...
            style={{ padding: "28px" }}
          >
            <div style={{ color: course.color, marginBottom: "16px" }}>
              {course.icon}
            </div>
            <h3
              style={{
      ...
      {!submitted && !showForm && (
        ...
        >
          <h2
            style={{ fontSize: "22px", fontWeight: "800", marginBottom: "8px" }}
          >
            Ready to level up?
          </h2>
          <p style={{ color: "#888", marginBottom: "20px" }}>
            Sign up for a free coaching session. Limited slots available each
            week.
          </p>
          <motion.button
      ...
      <AnimatePresence>
        {submitted && (
          ...
          >
            <IoCheckmarkCircleOutline
              size={48}
              style={{ color: "#00c853", marginBottom: "12px" }}
            />
            <h2
              style={{
                fontSize: "22px",
            ...
            <p style={{ color: "#888" }}>
              We&apos;ll contact you within 48 hours to schedule your free
              coaching session.
            </p>
          </motion.div>
        )}
