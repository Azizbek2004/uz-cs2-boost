...
export default function PingBoosterPage() {
  ...
  const runScan = useCallback(async () => {
    ...
    for (let i = 0; i < CS2_SERVERS.length; i++) {
      ...
      for (let j = 0; j < 10; j++) {
        ...
        const simulated =
          server.baseLatency + (elapsed - 20) + (Math.random() * 15 - 7);
  ...
  const suggestions =
    results.length > 0
      ? [
          results[0].avgPing > 80 &&
            "Consider using a VPN like GearUp Booster to route through closer servers.",
          results[0].jitter > 15 &&
            "High jitter detected. Try switching to a wired connection.",
          results[0].packetLoss > 1 &&
            "Packet loss detected. Contact your ISP or try changing DNS to 1.1.1.1.",
                  ...
                  {results.map((r, i) => (
                    ...
                    >
                      ...
                      <td
                        style={{
                          padding: "12px 16px",
                          color: r.jitter < 10 ? "#00c853" : "#ffa726",
                        }}
                      >
                        {r.jitter}ms
                      </td>
                      <td
                        style={{
                          padding: "12px 16px",
                          color: r.packetLoss > 1 ? "#ff1744" : "#00c853",
                        }}
                      >
                        {r.packetLoss}%
                      </td>
            ...
            >
              <div>
                ...
                <p style={{ fontSize: "13px", color: "#888" }}>
                  Trusted VPN routing for gamers. Get lower ping to EU servers
                  from Uzbekistan.
                </p>
                <p
