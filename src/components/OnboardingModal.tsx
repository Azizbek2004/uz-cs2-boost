...
import { IoScanOutline, IoWalkOutline, IoBulbOutline, IoGameControllerOutline, IoShieldCheckmarkOutline } from "react-icons/io5";

const WEAKNESS_OPTIONS = [
    { id: "aim", label: "Flicking & Aim", icon: IoScanOutline, color: "#ff6b00" },
    { id: "spray", label: "Spray Control", icon: IoGameControllerOutline, color: "#00c853" },
    { id: "movement", label: "Movement & Peeks", icon: IoWalkOutline, color: "#007bff" },
    { id: "utility", label: "Utility & Nades", icon: IoShieldCheckmarkOutline, color: "#ffd700" },
    { id: "gameSense", label: "Game Sense", icon: IoBulbOutline, color: "#7c4dff" },
];
...
export default function OnboardingModal() {
    ...
    useEffect(() => {
        ...
        if (user && user.skillPoints) {
            const sum = Object.values(user.skillPoints).reduce((a: any, b: any) => a + b, 0);
            ...
            >
                <motion.div
                    ...
                    style={{
                        ...
                        boxShadow: "0 20px 40px rgba(0,0,0,0.5), 0 0 0 1px inset rgba(255,255,255,0.05)",
                    }}
                >
                    <h2
                        style={{
                    ...
                    <p style={{ color: "#aaa", fontSize: "14px", marginBottom: "24px", lineHeight: 1.5 }}>
                        To personalize your recommended training routine, tell us about your current gameplay.
                            ...
                            return (
                                <motion.div
                                    ...
                                    style={{
                                        ...
                                        borderRadius: "8px",
                                        cursor: "pointer",
                                        backgroundColor: isSelected ? "rgba(255, 107, 0, 0.1)" : "rgba(255, 255, 255, 0.03)",
                                ...
                                >
                                    ...
                                    <span style={{ fontSize: "16px", fontWeight: isSelected ? "700" : "500", color: isSelected ? "white" : "#ccc" }}>
                                        {option.label}
                                    </span>
                                </motion.div>
                            );
                    ...
                    >
                        {isSubmitting ? "Generating Profile..." : "Start Training Assessment (+100 UZS)"}
                    </button>
